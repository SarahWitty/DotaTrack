...
class Model_DotaTrack extends Model {
	...
	protected $statisticsProjectionWhitelist = array(
		"matchId" => "/(Asc|Desc|Not)/i",
		"duration" => "/(Asc|Desc|Not)/i",
		"result" => "/(Asc|Desc|Not)/i",
		"gameMode" => "/(Asc|Desc|Not)/i",
		"date" => "/(Asc|Desc|Not)/i",
		"matchType" => "/(Asc|Desc|Not)/i",
		"performanceId" => "/(Asc|Desc|Not)/i",
		"playerId" => "/(Asc|Desc|Not)/i",
		"level" => "/(Asc|Desc|Not)/i",
		"hero" => "/(Asc|Desc|Not)/i",
		"kills" => "/(Asc|Desc|Not)/i",
		"deaths" => "/(Asc|Desc|Not)/i",
		"assists" => "/(Asc|Desc|Not)/i",
		"lastHits" => "/(Asc|Desc|Not)/i",
		"denies" => "/(Asc|Desc|Not)/i",
		"xpm" => "/(Asc|Desc|Not)/i",
		"gpm" => "/(Asc|Desc|Not)/i",
		"heroDamage" => "/(Asc|Desc|Not)/i",
		"towerDamage" => "/(Asc|Desc|Not)/i",
		"item0" => "/(Asc|Desc|Not)/i",
		"item1" => "/(Asc|Desc|Not)/i",
		"item2" => "/(Asc|Desc|Not)/i",
		"item3" => "/(Asc|Desc|Not)/i",
		"item4" => "/(Asc|Desc|Not)/i",
		"item5" => "/(Asc|Desc|Not)/i",
		"position" => "/(Asc|Desc|Not)/i",
		"tag" => "/(Asc|Desc|Not)/i"
	);
