...
class Model_Api extends Model
{
	...
	// Output: matchDataHash, all the data from the requested match. There is not a format for this yet.
	//
	//
	// Request format:
	...
	public function internal_get_match_data($matchId) {
		...
		$matchDetails = json_decode(file_get_contents($requestAddress));
		return $matchDetails;
	}
